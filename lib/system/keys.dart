...
class Keys {
  ...
  //----- app key -----------------------------------------------------------------
  static const setting$askSendSmsEveryTime = 'setting_ask_send_sms_every_time';
  static const setting$defaultSimSlot = 'setting_default_sim_slot';
  static const setting$unLockByBiometric = 'setting_unLockByBiometric';
